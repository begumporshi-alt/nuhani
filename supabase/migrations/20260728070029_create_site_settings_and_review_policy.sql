...
CREATE TABLE IF NOT EXISTS public.site_settings (
  ...
  logo_url text,
  site_name text DEFAULT 'Nuhani',
  phone text DEFAULT '+880 1700 000000',
  email text DEFAULT 'hello@nuhani.com',
...
-- Seed default row
INSERT INTO public.site_settings (logo_url, site_name, phone, email, address, instagram_url, facebook_url)
VALUES ('/logo.svg', 'Nuhani', '+880 1700 000000', 'hello@nuhani.com', 'Dhaka, Bangladesh', 'https://instagram.com', 'https://facebook.com')
