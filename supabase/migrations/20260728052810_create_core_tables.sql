...
## Summary
Creates all 12 core tables for the Nuhani e-commerce platform:
...
CREATE TABLE IF NOT EXISTS public.orders (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  order_number text UNIQUE NOT NULL DEFAULT ('NU-' || lpad(nextval('public.order_number_seq')::text, 6, '0')),
