...
import { supabase, fetchPublicSettings, type PublicSettings } from '../lib/supabase'
...
export default function Contact() {
  ...
  return (
    <div className="section-padding py-12 max-w-5xl mx-auto animate-fade-in">
      <Seo
        title="Contact Us"
        description="Get in touch with Nuhani. We respond within 24 hours to questions about orders, sizing, shipping and returns across Bangladesh."
        path="/contact"
      />
      <div className="text-center mb-10">
        <h1 className="text-3xl font-serif text-ink-800 mb-3">Get in Touch</h1>
        <p className="text-ink-500">We'd love to hear from you. Send us a message and we'll respond within 24 hours.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card p-8 max-w-2xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Your Name</label>
            <input
              type="text"
              value={form.name}
        ...
        <div className="mb-4">
          <label className="text-sm text-ink-600 mb-1.5 block">Subject</label>
          <input
            type="text"
            value={form.subject}
        ...
        <div className="mb-6">
          <label className="text-sm text-ink-600 mb-1.5 block">Message</label>
          <textarea
            value={form.message}
