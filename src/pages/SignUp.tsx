...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      showToast('Account created! Welcome to Nuhani.', 'success')
      navigate('/account')
    }
    setLoading(false)
  }
  ...
  return (
    <div className="section-padding py-12 max-w-md mx-auto animate-fade-in">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-serif text-ink-800 mb-2">Join Our Family</h1>
        <p className="text-ink-400 text-sm">Create your account</p>
      </div>
      ...
      <p className="text-center text-sm text-ink-500 mt-6">
        ...
        <Link to="/login" className="text-mink-500 hover:text-mink-600 font-medium">
          Sign in
        </Link>
      </p>
    </div>
