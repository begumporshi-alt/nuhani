...
export default function AdminSettings() {
  ...
  if (!settings) {
    return <div className="section-padding py-20 text-center"><p className="text-ink-400">Settings not found.</p></div>
  }

  return (
    <div className="section-padding py-8 max-w-2xl mx-auto animate-fade-in">
      <AdminBackLink />
      <h1 className="text-3xl font-serif text-ink-800 mb-8">Site Settings</h1>

      {/* Logo */}
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-serif text-ink-800 mb-4">Logo</h2>
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-2xl bg-ivory-100 flex items-center justify-center overflow-hidden shrink-0">
            {settings.logo_url ? (
      ...
      {/* Contact Info */}
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-serif text-ink-800 mb-4">Contact Information</h2>
        <div className="space-y-4">
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><Phone size={14} /> Phone</label>
            <input type="text" value={settings.phone} onChange={(e) => setSettings({ ...settings, phone: e.target.value })} className="input-field" />
          </div>
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><Mail size={14} /> Email</label>
            <input type="email" value={settings.email} onChange={(e) => setSettings({ ...settings, email: e.target.value })} className="input-field" />
          </div>
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><MapPin size={14} /> Address</label>
      ...
      {/* Social Media */}
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-serif text-ink-800 mb-4">Social Media</h2>
        <div className="space-y-4">
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><Instagram size={14} /> Instagram URL</label>
          ...
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><Facebook size={14} /> Facebook URL</label>
          ...
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><Youtube size={14} /> YouTube URL</label>
          ...
          <div>
            <label className="text-sm text-ink-600 mb-1.5 flex items-center gap-1.5"><Twitter size={14} /> Twitter URL</label>
      ...
      {/* Courier Integration */}
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-serif text-ink-800 mb-4 flex items-center gap-2"><Truck size={18} /> Courier Integration</h2>
        <div className="space-y-4">
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Default Courier Provider</label>
            <select
          ...
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Pathao API Key</label>
            <input
              type="password"
            ...
            />
            <p className="text-xs text-ink-400 mt-1">Get your API key from Pathao merchant portal.</p>
          </div>
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Steadfast API Key</label>
            <input
              type="password"
            ...
            />
            <p className="text-xs text-ink-400 mt-1">Get your API key from Steadfast courier portal.</p>
          </div>
        </div>
      </div>
      ...
      {/* Payment Gateway */}
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-serif text-ink-800 mb-4 flex items-center gap-2"><CreditCard size={18} /> Payment Gateway</h2>
        <div className="space-y-4">
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Payment Mode</label>
            <select
            ...
            <p className="text-xs text-ink-400 mt-1">Use sandbox mode while testing. Switch to live when ready to accept real payments.</p>
          </div>

          {/* SSLCommerz (Card) */}
          <div className="border-t border-stone-200 pt-4">
            <h3 className="text-sm font-medium text-ink-700 mb-3">SSLCommerz (Card Payments)</h3>
            <div className="space-y-3">
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">Store ID</label>
              ...
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">Store Password</label>
          ...
          {/* bKash */}
          <div className="border-t border-stone-200 pt-4">
            <h3 className="text-sm font-medium text-ink-700 mb-3">bKash</h3>
            <div className="space-y-3">
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">App Key</label>
              ...
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">App Secret</label>
              ...
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">Username</label>
              ...
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">Password</label>
          ...
          {/* Nagad */}
          <div className="border-t border-stone-200 pt-4">
            <h3 className="text-sm font-medium text-ink-700 mb-3">Nagad</h3>
            <div className="space-y-3">
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">Merchant ID</label>
              ...
              <div>
                <label className="text-sm text-ink-600 mb-1.5 block">API Key</label>
      ...
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-serif text-ink-800 mb-4 flex items-center gap-2"><Send size={18} /> Telegram & WhatsApp Integration</h2>
        <p className="text-sm text-ink-400 mb-4">Connect a Telegram bot to receive instant new-order notifications and offer live customer support. Create a bot with <a href="https://t.me/BotFather" target="_blank" rel="noopener noreferrer" className="text-mink-500 underline">@BotFather</a> on Telegram to get your bot token.</p>
        <div className="space-y-4">
          {/* Connect webhook button */}
          <div className="flex items-center gap-3 p-3 rounded-2xl bg-ivory-100">
            {telegramConnected ? (
              <CheckCircle2 size={20} className="text-green-600 shrink-0" />
            ) : (
              <Link2 size={20} className="text-ink-400 shrink-0" />
            )}
            <div className="flex-1">
              <p className="text-sm font-medium text-ink-700">Telegram Webhook</p>
              <p className="text-xs text-ink-400">Registers your bot so it can receive and reply to customer messages automatically.</p>
            </div>
            <button
          ...
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Bot Username (without @)</label>
            <input
              type="text"
              value={settings.telegram_bot_username ?? ''}
              onChange={(e) => setSettings({ ...settings, telegram_bot_username: e.target.value })}
              className="input-field"
              placeholder="nuhani_bot"
            />
            <p className="text-xs text-ink-400 mt-1">This is the bot customers will chat with for support and order tracking.</p>
          </div>
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Bot Token</label>
            <input
              type="password"
            ...
            />
            <p className="text-xs text-ink-400 mt-1">Get this from @BotFather when you create your bot.</p>
          </div>
          <div>
            <label className="text-sm text-ink-600 mb-1.5 block">Admin Chat ID</label>
            <input
              type="text"
            ...
            />
            <p className="text-xs text-ink-400 mt-1">Where new order notifications are sent. Message <a href="https://t.me/userinfobot" target="_blank" rel="noopener noreferrer" className="text-mink-500 underline">@userinfobot</a> on Telegram to find your chat ID.</p>
          </div>
          <div className="border-t border-stone-200 pt-4">
            <label className="text-sm text-ink-600 mb-1.5 block">WhatsApp Support Number</label>
            <input
              type="text"
            ...
            />
            <p className="text-xs text-ink-400 mt-1">Customers can tap a WhatsApp button to chat with you for support. Enter the number with country code, no + sign (e.g. 8801XXXXXXXXX).</p>
          </div>
        </div>
      </div>

      <button onClick={handleSave} disabled={saving} className="btn-primary w-full flex items-center justify-center gap-2">
        {saving ? <div className="w-5 h-5 border-2 border-ivory-50 border-t-transparent rounded-full animate-spin" /> : <Save size={18} />}
        Save Settings
      </button>
    </div>
  )
