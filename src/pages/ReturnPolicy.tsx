...
export default function ReturnPolicy() {
  return (
    <div className="section-padding py-12 max-w-3xl mx-auto animate-fade-in">
      <h1 className="text-3xl font-serif text-ink-800 mb-8">Returns & Exchange</h1>

      <div className="space-y-8">
        <section className="card p-6">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-mink-100 flex items-center justify-center">
              <RefreshCw size={20} className="text-ink-700" />
            </div>
            <h2 className="text-xl font-serif text-ink-800">7-Day Return Policy</h2>
          </div>
        ...
        <section className="card p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-xl font-serif text-ink-800">How to Return</h2>
          </div>
          <ol className="space-y-3 text-sm text-ink-600 list-decimal list-inside">
            <li>Email us at <strong>hello@nuhani.com</strong> with your order number and reason for return.</li>
        ...
        <section className="card p-6">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-mink-100 flex items-center justify-center">
              <AlertCircle size={20} className="text-ink-700" />
            </div>
            <h2 className="text-xl font-serif text-ink-800">Non-Returnable Items</h2>
          </div>
          <ul className="space-y-2 text-sm text-ink-600">
        ...
        <div className="bg-mink-50 rounded-2xl p-6 text-sm text-ink-600">
