...
/**
 * Public, non-secret subset of site_settings returned by the get_public_settings()
 * RPC. The table itself is admin-only (it stores payment/courier/Telegram secrets).
 */
